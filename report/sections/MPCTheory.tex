...
and consists of the steps \textbf{initialize}, \textbf{input}, \textbf{add}, \textbf{multiply}, and \textbf{output}. These steps are executed as needed to evaluate the arithmetic circuit that we wish to evaluate.
...
\section{Choosing parameters for our MPC system} \label{sec:choosing-parameters}
    ...
    Let $N$ be the degree of our polynomial $f(x)$ in the Ring-LWE encryption scheme, % TODO: cite the section.
