...
\section{Choosing parameters for our MPC system} \label{sec:choosing-parameters}
    ...
    \\[5mm]
    While this provides pretty good security, it is by no means effective for us to run, and we miss the entry-wise multiplication optimisation, %TODO: indsæt ref
