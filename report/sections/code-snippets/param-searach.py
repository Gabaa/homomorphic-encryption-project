...
q_size = 2 * Z * (1 + 2**SEC)
print("The bit size of p should be above: ", floor(log2(q_size)))

chosen_q = 6440092097492369874468694478456476902429935263779065830479393474203066496323859298183983608879
gamma = 1.005
